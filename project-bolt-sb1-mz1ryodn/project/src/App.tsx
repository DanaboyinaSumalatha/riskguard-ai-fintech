...
import shieldImg from './shield-3d.png';
  ...
  return (
    <div className="min-h-screen bg-[#050A14] text-white relative overflow-hidden">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 pt-12 pb-8 text-center">
        ...
        {/* ✅ ONLY THIS IMAGE CHANGED - REST SAME */}
        <div className="mt-12 relative mx-auto w-[380px] md:w-[580px] flex justify-center">
          ...
          <img src={shieldImg} alt="3D Shield" className="relative w-full h-auto object-contain drop-shadow-[0_0_80px_rgba(34,211,238,0.8)]" />
        </div>
