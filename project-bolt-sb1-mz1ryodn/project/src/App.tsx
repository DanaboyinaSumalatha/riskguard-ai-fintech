      ...
      <section id="product" className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 pt-12 pb-8 text-center">
        ...
        <div className="mt-12 relative mx-auto w-[400px] md:w-[560px] flex flex-col items-center">
          ...
          <svg viewBox="0 0 400 480" className="relative w-[380px] md:w-[460px] h-auto drop-shadow-[0_0_80px_rgba(94,225,255,0.8)]">
            <defs><radialGradient id="g1" cx="50%" cy="45%" r="60%"><stop offset="0%" stopColor="#5EE1FF" stopOpacity="0.8"/><stop offset="100%" stopColor="#0A1930" stopOpacity="0"/></radialGradient><linearGradient id="g2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#7FE8FF" stopOpacity="0.9"/><stop offset="50%" stopColor="#2DD4FF" stopOpacity="0.4"/><stop offset="100%" stopColor="#0F2A5A" stopOpacity="0.8"/></linearGradient></defs>
        ...
        <div id="features" className="mt-10 grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
          ...
          <div id="pricing" className="bg-[#0F1C2E]/60 border border-white/[0.08] rounded-2xl p-5"><p className="font-bold">Sub-50ms Detection</p><p className="text-[11px] text-white/40">Real-time response</p></div>
