...
import shieldImage from './shield-3d.png'; // <-- ONLY NEW LINE
  ...
  return (
    <div className="min-h-screen bg-[#050A14] text-white relative overflow-hidden">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 md:px-16 pt-12 pb-8 text-center">
        ...
        {/* ONLY THIS PART CHANGED - 3D IMAGE */}
        <div className="mt-12 relative mx-auto w-[360px] md:w-[500px] flex justify-center">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-cyan-400/20 blur-[70px] rounded-full"></div>
          <img
            src={shieldImage}
            alt="3D Shield"
            className="relative w-full h-auto object-contain drop-shadow-[0_0_80px_rgba(34,211,238,0.7)]"
          />
        </div>
